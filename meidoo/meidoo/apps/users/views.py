...
from goods.serialzers import SKUSerializer
...
class UserDetailView(RetrieveAPIView):
    ...
    # get_object(self) 返回详情视图所需的模型类数据对象，默认使用lookup_field参数
    # 来过滤queryset。 在试图中可以调用该方法获取详情信息的模型类对象。
    def get_object(self):   # 获得对象怎么使用
...
class UserBrowersingHistoryView(CreateAPIView):
# class UserBrowersingHistoryView():
    """用户浏览历史记录"""
